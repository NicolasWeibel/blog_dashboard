          ...
          <div className="lg:flex min-w-0 lg:flex-1 items-center">
            <figure className="lg:flex-shrink-0">
              {data.thumbnail ? (
                ...
                <div className="h-64 lg:w-96 w-full rounded bg-gray-200"></div>
              )}
            </figure>
            <div className="min-w-0 flex-1 px-8 p-4 ">
              ...
              <div className="lg:absolute lg:top-28">
                {data.status === "published" ? (
                  <>
                    <span className=" rounded-full p-1 px-2 bg-green-200 text-green-700  mx-1 font-medium text-sm ">
                      Published
                    </span>{" "}
                  ...
                  <>
                    <span className=" rounded-full p-1 px-2 bg-gray-200 text-gray-700  mx-1 font-mediu text-sm ">
                      Draft
                    </span>{" "}
                    <span className="text-gray-300">&middot;</span>
                  </>
